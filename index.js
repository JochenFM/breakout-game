...
timerId = setInterval(moveBall, 20) //invoke the function every 30ms
...
function checkForCollisions() {
    ...
    for (let i =0; i < blocks.length; i++) {
        if (
            ...
            allBlocks[i].classList.remove('block')//removes block we are dealing with (i), but not from array
